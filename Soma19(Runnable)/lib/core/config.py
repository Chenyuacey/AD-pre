...
import nn as mynn
from utils.my_collections import AttrDict
...
__C.PP_METHOD = 'norm1' # for image pre-process
...
__C.TRAIN.IN_SIZE = (64, 240, 240)
__C.TRAIN.IM_SIZE = (128, 256, 256)
...
__C.TEST.IN_SIZE = (64, 240, 240)
__C.TEST.CROP_OVLP = 32
...
def assert_and_infer_cfg(make_immutable: object = True) -> object:
...
def merge_cfg_from_file(cfg_filename):
    ...
    with open(cfg_filename, 'r') as f:    #5.3 change [3:] , cut off when run train.sh
