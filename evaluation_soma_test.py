...
def calc_instance_segmentation_voc_prec_rec(
    ...
    score = []
    match = []
    save = True # True if save evaluation results
    if save:
        fid = open(r'C:\Users\Zhiyi\Desktop\GT_and_SegResult\83_trainsplit_test\step5999\eval_results.txt', 'w+')
    ...
    for img_name in img_names:
        ...
        pred_mask = io.imread(os.path.join(pred_mask_path, img_name))#
        gt_mask = io.imread(os.path.join(gt_mask_path, img_name))#
        ...
        pred_score = np.load(os.path.join(pred_mask_path, img_name.split('.')[0]+'.npy'))
...
if __name__ == "__main__":
    # pred_mask_path = '/home/zhiyi/Projects/Soma19/Bi_output'# instance segmentation results
    # gt_mask_path = '/home/zhiyi/Data/soma/set2/mask_instance'# ground truth instance mask
    pred_mask_path = r'C:\Users\Zhiyi\Desktop\GT_and_SegResult\83_trainsplit_test\step5999\Seg'
    gt_mask_path = r'C:\Users\Zhiyi\Desktop\GT_and_SegResult\83_trainsplit_test\step5999\GT_ins'
